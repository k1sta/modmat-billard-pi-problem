...
\begin{frame}[plain]
    \centering
    \vfill
    {\Huge \usebeamerfont{section title}\usebeamercolor[fg]{section title}Identificação do Problema}
    \vfill
\end{frame}
...
\begin{frame}[plain]
    \centering
    \vfill
    {\Huge \usebeamerfont{section title}\usebeamercolor[fg]{section title}Modelagem do Problema}
    \vfill
\end{frame}
...
\begin{frame}[plain]
    \centering
    \vfill
    {\Huge \usebeamerfont{section title}\usebeamercolor[fg]{section title}Solução do Problema}
    \vfill
\end{frame}
...
\begin{frame}[plain]
    \centering
    \vfill
    {\Huge \usebeamerfont{section title}\usebeamercolor[fg]{section title}Experimentos}
    \vfill
\end{frame}
